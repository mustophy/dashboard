    ...
    return (
        <div className='flex items-center pr-4 sm:px-14 border-b border-gray-600 pb-5'>
            ...
            <div className="ml-auto flex gap-x-9 mt-3 sm:mt-0 items-center">
                ...
                <div className="h-12 w-12 rounded-full bg-green-900"></div>
            </div>
        </div>
    )
}
